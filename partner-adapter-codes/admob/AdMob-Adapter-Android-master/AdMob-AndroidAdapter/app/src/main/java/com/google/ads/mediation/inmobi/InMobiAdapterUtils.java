...
class InMobiAdapterUtils {
    ...
    public static void buildAdRequest(MediationAdRequest mediationAdRequest,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (city != "" && !Objects.equals(state, "") && !Objects.equals(country, "")) {
    ...
    private static AgeGroup getAgeGroup(String value) {
        if (value.equals(InMobiNetworkValues.ABOVE_55)) {
            return AgeGroup.ABOVE_55;
        } else if (value.equals(InMobiNetworkValues.BELOW_18)) {
            return AgeGroup.BELOW_18;
        } else if (value.equals(InMobiNetworkValues.BETWEEN_18_AND_20)) {
            return AgeGroup.BETWEEN_18_AND_20;
        } else if (value.equals(InMobiNetworkValues.BETWEEN_21_AND_24)) {
            return AgeGroup.BETWEEN_21_AND_24;
        } else if (value.equals(InMobiNetworkValues.BETWEEN_25_AND_34)) {
            return AgeGroup.BETWEEN_25_AND_34;
        } else if (value.equals(InMobiNetworkValues.BETWEEN_35_AND_54)) {
    ...
    private static Ethnicity getEthnicity(String value) {
        if (value.equals(InMobiNetworkValues.ETHNICITY_AFRICAN_AMERICAN)) {
            return Ethnicity.AFRICAN_AMERICAN;
        } else if (value.equals(InMobiNetworkValues.ETHNICITY_ASIAN)) {
            return Ethnicity.ASIAN;
        } else if (value.equals(InMobiNetworkValues.ETHNICITY_CAUCASIAN)) {
            return Ethnicity.CAUCASIAN;
        } else if (value.equals(InMobiNetworkValues.ETHNICITY_HISPANIC)) {
    ...
    private static HouseHoldIncome getHouseHoldIncome(String value) {
        if (value.equals(InMobiNetworkValues.ABOVE_USD_150K)) {
            return HouseHoldIncome.ABOVE_USD_150K;
        } else if (value.equals(InMobiNetworkValues.BELOW_USD_5K)) {
            return HouseHoldIncome.BELOW_USD_5K;
        } else if (value.equals(InMobiNetworkValues.BETWEEN_USD_100K_AND_150K)) {
            return HouseHoldIncome.BETWEEN_USD_100K_AND_150K;
        } else if (value.equals(InMobiNetworkValues.BETWEEN_USD_10K_AND_15K)) {
            return HouseHoldIncome.BETWEEN_USD_10K_AND_15K;
        } else if (value.equals(InMobiNetworkValues.BETWEEN_USD_15K_AND_20K)) {
            return HouseHoldIncome.BETWEEN_USD_15K_AND_20K;
        } else if (value.equals(InMobiNetworkValues.BETWEEN_USD_20K_AND_25K)) {
            return HouseHoldIncome.BETWEEN_USD_20K_AND_25K;
        } else if (value.equals(InMobiNetworkValues.BETWEEN_USD_25K_AND_50K)) {
            return HouseHoldIncome.BETWEEN_USD_25K_AND_50K;
        } else if (value.equals(InMobiNetworkValues.BETWEEN_USD_50K_AND_75K)) {
            return HouseHoldIncome.BETWEEN_USD_50K_AND_75K;
        } else if (value.equals(InMobiNetworkValues.BETWEEN_USD_5K_AND_10K)) {
            return HouseHoldIncome.BETWEEN_USD_5K_AND_10K;
        } else if (value.equals(InMobiNetworkValues.BETWEEN_USD_75K_AND_100K)) {
